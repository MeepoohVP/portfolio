...
changeText1 = () => {
    ...
    document.getElementById("next").innerHTML = '<button class="prev" onclick ="changeText();rev5();" style="background: #fff;"><< Previous</button>&nbsp;&nbsp;<button class="next" onclick = "changeText2();dot2();">Next >></button>';
}
changeText2 = () => {
    document.getElementById("text").innerHTML = "<span style='color: #ffb6a1;'>อายุ</span> 17 ปี";
    document.getElementById("next").innerHTML = '<button class="prev" onclick ="changeText1();rev4();" style="background: #fff;"><< Previous</button>&nbsp;&nbsp;<button class="next" onclick = "changeText3();dot3();">Next >></button>'
}
changeText3 = () => {
    document.getElementById("text").innerHTML = "<span style='color: #ffb6a1;'>วันเกิด</span> 11 พฤศจิกายน 2547";
    document.getElementById("next").innerHTML = '<button class="prev" onclick ="changeText2();rev3();" style="background: #fff;"><< Previous</button>&nbsp;&nbsp;<button class="next" onclick = "changeText4();dot4();">Next >></button>'
}
changeText4 = () => {
    document.getElementById("text").innerHTML = "<span style='color: #ffb6a1;'>ศึกษาที่</span><br>โรงเรียนบางปะกอกวิทยาคม";
    document.getElementById("next").innerHTML = '<button class="prev" onclick ="changeText3();rev2();" style="background: #fff;"><< Previous</button>&nbsp;&nbsp;<button class="next" onclick = "changeText5();dot5()">Next >></button>'
}

changeText5 = () => {
    document.getElementById("text").innerHTML = "<span style='color: #ffb6a1;'>งานอดิเรก</span> Coding, เลี้ยงแมว";
    document.getElementById("next").innerHTML = '<button class="prev" onclick ="changeText4();rev1();" style="background: #fff;"><< Previous</button>&nbsp;&nbsp;<button class="next" onclick = "changeText6();dot6()">Next >></button>'
}
changeText6 = () => {
    document.getElementById("text").innerHTML = "<span class = 'coding'>My skill</span><br>"
    ...
    document.getElementById("next").innerHTML = '<button class="prev" onclick ="changeText5();rev6();" style="background: #fff;"><< Previous</button>'
}
